 ...
 public static class BlockTableRecordExtensions
    {
     ...
     /// <returns></returns>
        ...
        public static IEnumerable<BlockReference> GetAllBlockReferences(this BlockTableRecord btr, Transaction trx, bool directOnly, bool forceValidity)
        {
        ...
        public static IEnumerable<BlockReference> GetAllBlockReferences(this BlockTableRecord btr, bool directOnly, bool forceValidity)
        {

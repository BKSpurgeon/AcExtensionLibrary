...
namespace Autodesk.AutoCAD.DatabaseServices
{
    public static class DatabaseExtensions
    {
       ...
       public static BlockTableRecord ModelSpace(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead)
        ...
        public static DBDictionary NamedObjectDBDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static DBDictionary MLStyleDBDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static DBDictionary LayoutDBDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static DBDictionary PlotSettingsDBDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static DBDictionary TableStyleDBDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static DBDictionary MLeaderStyleDBDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static GroupDictionary GroupDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead, bool includingErased = false)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static GroupDictionary GroupDictionary(this Database db, OpenMode mode = OpenMode.ForRead, bool includingErased = false)
        {
            return db.GroupDictionary(db.TransactionManager.TopTransaction, mode, includingErased);
        }

        public static MLStyleDictionary MLStyleDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead, bool includingErased = false)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static MLStyleDictionary MLStyleDictionary(this Database db, OpenMode mode = OpenMode.ForRead, bool includingErased = false)
        {
            return db.MLStyleDictionary(db.TransactionManager.TopTransaction, mode, includingErased);
        }

        public static LayoutDictionary LayoutDictionary(this Database db, Transaction trx, OpenMode mode = OpenMode.ForRead, bool includingErased = false)
        {
            if (trx == null)
            {
                throw new NoActiveTransactionException("No active Transaction");
        ...
        public static LayoutDictionary LayoutDictionary(this Database db, OpenMode mode = OpenMode.ForRead, bool includingErased = false)
        {
